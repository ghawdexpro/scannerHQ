...
const FROM_EMAIL = process.env.SENDGRID_FROM_EMAIL || 'admin@ghawdex.pro'
const FROM_NAME = 'Ghawdex Engineering'
const TEAM_EMAIL = process.env.TEAM_NOTIFICATION_EMAIL || 'admin@ghawdex.pro'
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div style="text-align: center;">
        <a href="mailto:admin@ghawdex.pro?subject=Quote ${data.quoteId.substring(0, 8)}" class="cta-button">
    ...
    <div class="footer">
      ...
      📧 admin@ghawdex.pro | 🌐 www.ghawdex.pro</p>
